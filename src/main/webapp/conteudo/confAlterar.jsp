        	...
        	<div class="LogContainer">
	            <div class="cad">
	            	<%
	            		...
	            		if (acao.equals("0")){
	            			out.write("<label id='msgRec' aria-hidden='true'> Falha ao realizar o alterações </label>");
	            			...
	            			out.write("<label id='msgRec' aria-hidden='true'> Informações alteradas com sucesso </label>");
