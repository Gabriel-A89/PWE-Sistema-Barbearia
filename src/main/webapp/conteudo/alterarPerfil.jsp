					...
					<div id="ajust">
						...
						<div id="infoAlt">
							<form name="alteracao" id="formAlt" method="post" action="alterarperfil" enctype="multipart/form-data">
						        ...
						        <input onchange="VerificacaoAlt(this.value)" class="formInput" type="text" name="name" required value="<%=usuario.getNome() %>" placeholder="Nome Completo">
						        <br>
						        <h4 class="titulo">Telefone:</h4>
						        <input onchange="VerificacaoAlt(this.value)" class="formInput" type="tel" name="telefone" pattern="+[0-9]{13}" maxlength='14' required value="<%=usuario.getTelefone() %>" placeholder="+9999999999999">
